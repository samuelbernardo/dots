...
--	 local keydocbox = widget({ type = "textbox" })
--	 assert(skey, "SKEY is null!!")
--	 assert(help, "Help message is null for keybind: " .. skey)
--	 assert(beautiful.fg_widget_value, "ERROR: fg_widget_value is null with keybind: " .. skey .. " with help message: " .. help)
