...
beautiful.init("/home/samuel/.config/awesome/themes/default/theme.lua")
...
function batteryShow(adapter)
    ...
    if batInfos then
      ...
      naughty.notify({title = "Battery level",text = infos})
end
...
mymainmenu = awful.menu({ items = { { "awesome", myawesomemenu, beautiful.awesome_icon },
                                    { "Debian", debian.menu.Debian_menu.Debian },
																		...
																		{ "skype","skype"},
																		{ "linphone","linphone"},
	 																	{ "log out", '/home/samuel/bin/shutdown_dialog.sh'},
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "w", function () awful.util.spawn("/usr/bin/python -O /usr/share/wicd/gtk/wicd-client.pyc") end, "Spawn WIFI Manager"),
